...
int main (void) // Devuelve int para informar al S.O. de cómo fue todo.
{
  ...
  while(TRUE)
  {
    ...
    {
      case 'N': // NORTE, arriba.
      if (posy > 0) // ¿Nos salimos del mapa por arriba?
      {
        if (mapa[posy-1][posx] != '#') // ¿Hay MURO O HUECO?
        {
      ...
      case 'S': // SUR, abajo.
      if (posy < ultimay) // ¿Nos salimos del mapa por abajo?
      {
        if (mapa[posy+1][posx] != '#') // ¿Hay MURO O HUECO?
        {
          mapa[posy][posx] = ' '; // Limpiamos posición actual del mapa.
      ...
      if (posx < ultimax) // ¿Nos salimos del mapa por la derecha?
      {
        if (mapa[posy][posx+1] != '#') // ¿Hay MURO O HUECO?
        {
          mapa[posy][posx] = ' '; // Limpiamos posición actual del mapa.
          posx = posx + 1;
        }
      ...
      if (posx > 0) // ¿Nos salimos del mapa por la izquierda?
      {
        if (mapa[posy][posx-1] != '#') // ¿Hay MURO O HUECO?
        {
          mapa[posy][posx] = ' '; // Limpiamos posición actual del mapa.
